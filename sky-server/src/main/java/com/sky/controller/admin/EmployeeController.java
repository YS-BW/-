...
public class EmployeeController {
    ...
    public Result<String> resetStatus(@PathVariable Integer status, @RequestParam Long id) {
        log.info("启用、禁用员工账号：{},{}", status, id);
        //调用service
        employeeService.resetStatus(status, id);
        return Result.success();
    }
    /**
     * 根据id查询员工信息
    ...
    @PutMapping
    @ApiOperation("修改员工信息")
    public Result<String> updateEmp(@RequestBody EmployeeDTO dto) {
        log.info("修改员工信息：{}", dto);
